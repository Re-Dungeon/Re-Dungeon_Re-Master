...
const NpcForm = ({ initialValues, personagens, onSubmit, onCancelar, labelSalvar, idPrefix }) => (
  <Formik initialValues={initialValues} validationSchema={NPC_SCHEMA} onSubmit={onSubmit}>
              ...
              <FastField name="personalidade">
                {({ field }) => (
                  <TextField
                    ...
                    multiline
                    rows={2}
                    error={touched.personalidade && Boolean(errors.personalidade)}
              ...
              <FastField name="relacionamentos">
                {({ field }) => (
                  <TextField
                    ...
                    multiline
                    rows={2}
                    error={touched.relacionamentos && Boolean(errors.relacionamentos)}
                    helperText={touched.relacionamentos && errors.relacionamentos}
                    sx={inputSx}
                  />
                )}
              </FastField>
              <FastField name="informacoesSecretas">
                {({ field }) => (
                  <TextField
                    ...
                    multiline
                    rows={3}
                    error={touched.informacoesSecretas && Boolean(errors.informacoesSecretas)}
                    helperText={touched.informacoesSecretas && errors.informacoesSecretas}
                    sx={inputSx}
                  />
                )}
              </FastField>
              ...
              <FastField name="observacoesPessoais">
                {({ field }) => (
                  <TextField
                    ...
                    multiline
                    rows={3}
                    error={touched.observacoesPessoais && Boolean(errors.observacoesPessoais)}
                    helperText={touched.observacoesPessoais && errors.observacoesPessoais}
                    sx={inputSx}
                  />
                )}
              </FastField>
